...
export default function DarkModeSwitcher() {
    return (
        <button id="theme-toggle" type="button" className="text-black dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
