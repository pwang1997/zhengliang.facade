export default function Button({ name, handleOnClick }: { name?: string, handleOnClick?: any }) {
    return (
        <button
            ...
            from-sky-400 to-emerald-600 group-hover:from-sky-500 group-hover:to-emerald-700
             dark:from-purple-500 dark:to-blue-400 dark:group-hover:from-purple-600 dark:group-hover:to-blue-500
